...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'systemProIot';
    ...
    'jhipster.mail.from' = 'systemProIot@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'systemProIot API';
    'jhipster.swagger.description' = 'systemProIot API documentation';
    ...
    'eureka.instance.appname' = 'systemProIot';
    'eureka.instance.instanceId' = 'systemProIot:${random.value}';
    ...
    'cloud.config.name' = 'systemProIot';
